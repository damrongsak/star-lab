...
describe("InvoiceService Search Functionality", () => {
    ...
    describe("getAllInvoices with search", () => {
        ...
        it("should apply status filter when payment status is provided", async () => {
            const mockInvoices = [{ id: "inv-1", invoiceNo: "INV-001", paymentStatus: "PAID" }];
            const totalCount = 1;
    ...
    describe("getInvoicesByCustomer with search", () => {
        ...
        it("should apply status filter when payment status is provided", async () => {
            const mockInvoices = [{ id: "inv-1", invoiceNo: "INV-001", paymentStatus: "CANCELLED" }];
            const totalCount = 1;
            const customerId = "cust-123";
            ...
            await invoiceService.getInvoicesByCustomer(customerId, 1, 10, "CANCELLED", undefined);
