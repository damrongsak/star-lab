...
describe("Invoice Workflow Integration", () => {
    ...
    it("should automatically generate invoice when test request is completed", async () => {
        ...
        expect(mockInvoiceService.generateInvoiceFromTestRequest).toHaveBeenCalledWith(
            testRequestId,
            userId
        );
    });
    ...
    it("should NOT generate invoice when status is not COMPLETED", async () => {
        ...
        expect(mockInvoiceService.generateInvoiceFromTestRequest).not.toHaveBeenCalled();
    });
    ...
    it("should handle invoice generation errors gracefully", async () => {
        ...
        expect(mockInvoiceService.generateInvoiceFromTestRequest).toHaveBeenCalled();
    });
});
