...
function AppContent() {
  ...
  // The signin route does not use the main layout or sidebar.
  const isLabRoute = userProfile.role && location.pathname !== "/signin";
  const isSignInPage = location.pathname === "/signin";

  // If it's the sign-in page, render only the Outlet.
  // The Router will match the /signin route directly to SignIn.tsx.
  if (isSignInPage) {
    return <Outlet />;
  }
